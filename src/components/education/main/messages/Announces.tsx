...
import AnnounceCard from '~/components/education/main/components/AnnounceCard';
import { MessagesShortcuts } from '~/components/education/main/components/MessagesShortcuts';
