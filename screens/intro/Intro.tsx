...
const slides: ISlide[] = [
  ...
  },
  {
    ...
    text:
      'Даже при отсутствии интернета Вы сможете узнать своё расписание!',
  ...
  },
  {
    ...
    text:
      'Приложение общается исключительно с серверами ЕТИС ПГНИУ, а все данные хранятся локально',
  ...
  },
  {
    ...
    text:
      'Мы свободно распространяем как приложение, так и его исходный код! Ссылка находится в меню сервисов',
